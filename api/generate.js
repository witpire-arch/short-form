...
const SCENE_GUIDE = {
  '15': '4~5개 컷, 컷당 narration 8~15자',
  '30': '6~7개 컷, 컷당 narration 12~20자',
  '45': '8~9개 컷, 컷당 narration 15~25자',
};
...
규칙:
- narration은 컷당 1문장으로 아주 짧게. 한국어 TTS는 초당 약 5자라, 전체 분량이 목표 영상 길이를 넘지 않도록 엄격히 지키세요. 절대 길게 늘이지 마세요.
